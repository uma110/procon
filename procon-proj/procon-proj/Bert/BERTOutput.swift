...
extension BERT {
    ...
    func bestLogitsIndices(from prediction: BERTQAFP16Output, in range: Range<Int>) -> (start: Int, end: Int,score: Double)? {
        // Convert the logits MsLMultiArrays to [Double].
    ...
    func findBestLogitPair(startLogits: [Double],
                           ...
                           endLogits: [Double],
                           bestEndIndices: [Int]) -> (start: Int, end: Int, score:Double) {
